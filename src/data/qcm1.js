const RLTcf = [
  ...
  {   
    ...
    reponses: [
      { id: 'a', text: 'Des yeux bleus.', isCorrect: false },
      { id: 'b', text: 'Un sapin de Noël.', isCorrect: false },
      { id: 'c', text: 'Une pièce de monnaie.', isCorrect: false },
      { id: 'd', text: 'Une écharpe en soie.', isCorrect: true }
    ]
  },
   {   
    id: 'RLTcf1Q5',
    ...
    reponses: [
      { id: 'a', text: 'Hier matin.', isCorrect: false },
      { id: 'b', text: 'Samedi dernier.', isCorrect: false },
      { id: 'c', text: 'Il y a deux semaines.', isCorrect: false },
      { id: 'd', text: 'Dans quelques jours.', isCorrect: true }
    ]
  },
  {   
    id: 'RLTcf1Q6',
  ...
  {   
    ...
    questionType: 'COMPRÉHENSION ORALE',
    level: 'A2',
    question: 'Comment se sent Thomas ?',
  ...
  {   
    ...
    questionType: 'COMPRÉHENSION ORALE',
    level: 'A2',
    question: 'Comment peut-on participer au jeu ?',
  ...
  {   
    ...
    questionType: 'COMPRÉHENSION ORALE',
    level: 'B1',
    question: 'Quel est le travail de Jean ?',
  ...
  {   
    ...
    questionType: 'COMPRÉHENSION ORALE',
    level: 'B1',
    question: 'Pourquoi Sophie a-t-elle provoqué un accident ?',
  ...
  {   
    ...
    questionType: 'COMPRÉHENSION ORALE',
    level: 'B1',
    question: 'Quel est le genre du dernier film de Raymond Depardon ?',
    ...
    questionType: 'COMPRÉHENSION ORALE',
    level: 'B1',
    question: 'Dans quelle compétition Cristiano Ronaldo a-t-il marqué 12 buts en 2017 ?',
  ...
  {   
    ...
    questionType: 'COMPRÉHENSION ORALE',
    level: 'B1',
    question: 'Qui est Héloïse d’Ormesson ?',
  ...
  {   
    ...
    questionType: 'COMPRÉHENSION ORALE',
    level: 'B1',
    question: 'Quel objet la personne qui vote doit-elle obligatoirement montrer ?',
    ...
    questionType: 'COMPRÉHENSION ORALE',
    level: 'B2',
    question: 'Quelle découverte a été faite par des chercheurs suisses ?',
  ...
  {   
    ...
    questionType: 'COMPRÉHENSION ORALE',
    level: 'B2',
    question: 'Que présente la personne qui parle ?',
  ...
  {   
    ...
    questionType: 'COMPRÉHENSION ORALE',
    level: 'B2',
    question: 'Que nous apprend le journaliste sur la ligne de nuit Paris-Nice ?',
  ...
  {   
    ...
    questionType: 'COMPRÉHENSION ORALE',
    level: 'B2',
    question: 'Qu’apprend-on sur la Xylella fastidiosa, la bactérie évoquée dans ce document ?',
  ...
  {   
    ...
    questionType: 'COMPRÉHENSION ORALE',
    level: 'B2',
    question: 'Quel est le sujet de cette chronique ?',
    ...
    questionType: 'COMPRÉHENSION ORALE',
    level: 'C1',
    question: 'Quel est l’intérêt du roman dont il est question ici ?',
  ...
  {   
    ...
    questionType: 'COMPRÉHENSION ORALE',
    level: 'C1',
    question: 'Selon cette psychanalyste, pourquoi le décret sur la retouche des images est-il important ?',
  ...
  {   
    ...
    questionType: 'COMPRÉHENSION ORALE',
    level: 'C1',
    question: 'Qu’évoque cette intervenante ?',
  ...
  {   
    ...
    questionType: 'COMPRÉHENSION ORALE',
    level: 'C1',
    question: 'Pour quelle raison cet intervenant raconte-t-il son parcours ?',
  ...
  {   
    ...
    questionType: 'COMPRÉHENSION ORALE',
    level: 'C1',
    question: 'Quelle est l’opinion de cet intervenant concernant la sieste ?',
   ...
   {   
    ...
    questionType: 'COMPRÉHENSION ORALE',
    level: 'C2',
    question: 'Qui est l’homme dont on parle dans cette émission ?',
  ...
  {   
    ...
    questionType: 'COMPRÉHENSION ORALE',
    level: 'C2',
    question: 'Quel est le point de vue de cette intervenante sur la question animale ?',
  ...
  {   
    ...
    questionType: 'COMPRÉHENSION ORALE',
    level: 'C2',
    question: 'Quel phénomène contemporain décrit cet intervenant ?',
  ...
  {   
    ...
    questionType: 'COMPRÉHENSION ORALE',
    level: 'C2',
    question: 'Que présente cette journaliste ?',
